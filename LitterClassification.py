...
model = load_model('/Users/emilio.ee/Downloads/converted_keras (1)/keras_model.h5')

# Load the labels
label_path='/Users/emilio.ee/Downloads/converted_keras (1)/labels.txt'
class_names = open(label_path, "r").readlines()

test_image_path = "000000_jpg.rf.1b029d4c742673020fa91367070f5f51.jpg"
data = np.ndarray(shape=(1, 224, 224, 3), dtype=np.float32)

#initialize GUI
top = tk.Tk()
top.geometry('800x600')
top.title('Litter Classification')
...
heading = Label(top, text="Litter Classifier",pady=20, font=('arial',20,'bold'))
